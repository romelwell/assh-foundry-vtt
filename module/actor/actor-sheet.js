...
import { AsshEntityTweaks } from "../dialog/entity-tweaks.js";

export class AsshActorSheet extends ActorSheet {
  constructor(...args) {
    super(...args);
  }
  /* -------------------------------------------- */
  ...
  _onConfigureActor(event) {
    event.preventDefault();
    new AsshEntityTweaks(this.actor, {
  ...
  _getHeaderButtons() {
    ...
    if (this.options.editable && canConfigure) {
      buttons = [
        {
          label: game.i18n.localize("ASSH.dialog.tweaks"),
