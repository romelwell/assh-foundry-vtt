export class AsshPartyXP extends FormApplication {

    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["assh", "dialog", "party-xp"],
            template: "systems/assh/templates/apps/party-xp.html",
            width: 280,
            height: 400,
            resizable: false,
        });
     ...
     */
    get title() {
        return game.i18n.localize("ASSH.dialog.xp.deal");
    }
     ...
     */
    getData() {
        const actors = this.object.entities.filter(e => e.data.type === "character" && e.data.flags.assh && e.data.flags.assh.party === true);
        let data = {
            actors: actors,
            data: this.object,
            config: CONFIG.ASSH,
