import { AsshPartyXP } from "./party-xp.js";

export class AsshPartySheet extends FormApplication {

  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["assh", "dialog", "party-sheet"],
      template: "systems/assh/templates/apps/party-sheet.html",
      width: 280,
      height: 400,
      resizable: true,
    });
   ...
   */
  get title() {
    return game.i18n.localize("ASSH.dialog.partysheet");
  }
  ...
  async _dealXP(ev) {
    new AsshPartyXP(this.object, {}).render(true);
  }

  async _selectActors(ev) {
    const template = "/systems/assh/templates/apps/party-select.html";
    const templateData = {
